...
class GenTabLayout {
    ...
    reapplyPositions() {
        ...
        if (this.isSmallWindow) {
            ...
            // Reset top section styles
            this.topSection.style.display = '';
            this.topSection.style.flexDirection = '';
            this.topSection.style.height = '';
            this.topSection.style.whiteSpace = '';
            this.topSection.style.overflow = '';
            
            // Reset main image area styles
            this.mainImageArea.style.display = '';
            this.mainImageArea.style.width = '';
            this.mainImageArea.style.height = '';
            this.mainImageArea.style.minHeight = '';
            this.mainImageArea.style.order = '';
            this.mainImageArea.style.padding = '';
            this.mainImageArea.style.position = '';
            
            // Reset current image wrapbox styles
            this.currentImageWrapbox.style.display = '';
            this.currentImageWrapbox.style.width = '';
            this.currentImageWrapbox.style.height = '';
            this.currentImageWrapbox.style.minHeight = '';
            this.currentImageWrapbox.style.position = '';
            
            // Reset current image styles
            this.currentImage.style.display = '';
            this.currentImage.style.width = '';
            this.currentImage.style.height = '';
            this.currentImage.style.minHeight = '';
            this.currentImage.style.padding = '';
            this.currentImage.style.position = '';
            
            // Reset alt region styles
            this.altRegion.style.order = '';
            this.altRegion.style.marginTop = '';
            this.altRegion.style.padding = '';
            this.altRegion.style.top = '';
            
            // Reset bottom bar styles
            this.bottomBar.style.display = '';
            this.bottomBar.style.height = '';
            this.bottomBar.style.marginTop = '';
            this.bottomBar.style.order = '';
